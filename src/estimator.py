...
def estimator(data):
    ...
    dollarsInFlightC = infectionsByRequestedTimeC * avgDailyIncomePopulation * 100 * avgDailyIncomeInUSD * days
    dollarsInFlightS = infectionsByRequestedTimeS * avgDailyIncomePopulation * 100 * avgDailyIncomeInUSD * days
