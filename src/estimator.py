...
def estimator(data):
    ...
    dollarsInFlightC = float(infectionsByRequestedTimeC * avgDailyIncomePopulation * avgDailyIncomeInUSD * days)
    dollarsInFlightS = float(infectionsByRequestedTimeS * avgDailyIncomePopulation * avgDailyIncomeInUSD * days)
